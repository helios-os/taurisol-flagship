  ...
  return (
    <section className="relative overflow-hidden bg-shadow py-32 text-sand-light md:py-48">
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center md:px-12">
        ...
        <a
          href="#audience"
          className="group mt-12 inline-flex items-center gap-3 rounded-[10px] border border-sun/70 px-8 py-4 text-xs font-medium uppercase tracking-[0.25em] text-sand-light transition-all duration-300 hover:border-sun hover:bg-sun/[0.08] hover:shadow-[0_0_28px_-10px_var(--sun)]"
        >
