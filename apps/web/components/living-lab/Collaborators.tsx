...
export function Collaborators({ lang }: { lang: Lang }) {
  ...
  const invitations = [
    { id: "land", href: "/intra/land", number: "I.", q: t(c.land.q, lang), b: t(c.land.b, lang) },
    { id: "research", href: "/intra/research", number: "II.", q: t(c.research.q, lang), b: t(c.research.b, lang) },
    { id: "funding", href: "/intra/funding", number: "III.", q: t(c.funding.q, lang), b: t(c.funding.b, lang) },
    { id: "operator", href: "/intra/hermes", number: "IV.", q: t(c.operator.q, lang), b: t(c.operator.b, lang) },
  ];
  return (
